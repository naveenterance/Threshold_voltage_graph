...
def calc():
    ...
    u = 1* Na
    Na1 = np.arange(s,r,u)
    plt.title('VARIATION OF THRESHOLD VOLTAGE WITH DOPING CONCENTRATION')
    plt.plot(Na1,thresvol(Na1,v1),label='First Vsb:'+str(v1))
    plt.plot(Na1,thresvol(Na1,v2),label='Second Vsb:'+str(v2))
    plt.plot(Na1,thresvol(Na1,v3),label='Third Vsb:'+str(v3))
    plt.legend()
